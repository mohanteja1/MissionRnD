...
void Reversi_main(){
	...
	/*char *player1 = (char*)malloc(sizeof(char)*15);
	//char *player2 = (char*)malloc(sizeof(char) * 15);*/
	char player1[15], player2[15];
	printf("enter player 1 name :");
	scanf_s("%s", player1,15);
	printf("\nenter player 2 name :");
	scanf_s("%s", player2,15);
	...
	printf("Game is completed in %d Moves",game->NumberofMoves);
	//print winner
	printWinner(game);
